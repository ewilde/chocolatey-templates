#try { #error handling is only necessary if you need to do anything in addition to/instead of the main helpers
  ...
  Install-ChocolateyPackage 'reflector' 'EXE' '/iagreetotheeula' 'http://downloads.red-gate.com/ReflectorInstaller.exe' -validExitCodes @(0)
  ...
  #Install-ChocolateyZipPackage 'reflector' 'URL' "$(Split-Path -parent $MyInvocation.MyCommand.Definition)" '64BIT_URL_DELETE_IF_NO_64BIT' 
  
  # other helpers - using any of these means you want to uncomment the error handling up top and at bottom.
  # downloader that the main helpers use to download items
  #Get-ChocolateyWebFile 'reflector' 'DOWNLOAD_TO_FILE_FULL_PATH' 'URL' '64BIT_URL_DELETE_IF_NO_64BIT'
  # installer, will assert administrative rights - used by Install-ChocolateyPackage
  #Install-ChocolateyInstallPackage 'reflector' 'EXE_OR_MSI' 'SILENT_ARGS' '_FULLFILEPATH_' -validExitCodes @(0)
  ...
  #$target = Join-Path $MyInvocation.MyCommand.Definition 'reflector.exe'
  ...
  #Write-ChocolateySuccess 'reflector'
#} catch {
